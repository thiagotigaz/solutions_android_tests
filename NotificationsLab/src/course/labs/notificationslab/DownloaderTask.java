...
//							final PendingIntent pendingIntent = PendingIntent.getBroadcast(context, 0, restartMainActivtyIntent, PendingIntent.FLAG_UPDATE_CURRENT);
							...
							// successfully
							mContentView.setTextViewText(R.id.text, "Download is complete!");
